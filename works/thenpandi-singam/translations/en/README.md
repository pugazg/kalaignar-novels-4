# English Translation Controls — தென்பாண்டிச் சிங்கம்

English is a project-created derived layer.

## Authority hierarchy

1. verified canonical Tamil in `../../pages/`;
2. verified assembled Tamil in `../../sections/`;
3. maintained English in this directory.

If English conflicts with Tamil, Tamil governs.
...
- canonical / assembled / English body changes caused by release/readiness — **0 / 0 / 0**
- Part002 leakage — **0**
- 26→27 remains **PENDING direct audit / source-limited**
...
## Part003 E9 source-check

**E9 — SOURCE-CHECKED / COMPLETE.**

- English file — `sections/14-chapter-06-part003.md`
- Tamil authority — `../../sections/14-chapter-06-part003.md`
- scans — **54**
- literary blocks — **4/4**
- incoming 53→54 audited provenance — **retained**
...
## Part003 E9–E12 source-check closure

**E9–E12 — SOURCE-CHECKED / COMPLETE.**

- maintained Part003 English files — **4/4**
- translated/source-checked — **4/4 / 4/4**
- source coverage — **scans54–78 / all 25 supplied pages**
- unresolved English source-check holds — **0**
- canonical / assembled Tamil edits caused by English — **0 / 0**
- frozen Part001/Part002 English edits — **0**
- Part004 leakage — **0**
...
## Part003 English editorial review
...
## Part004 E15 source-check

**E15 — SOURCE-CHECKED / COMPLETE.**

- English file — `sections/20-chapter-11.md`
- Tamil authority — `../../sections/20-chapter-11.md`
- scans — **90–101**
- literary blocks — **68/68**
- provenance comments — **11/11 retained**
- scans97–98 — **2/2 non-literary inserts preserved / 0 English literary prose**
- cumulative translated/source-checked — **3/4 / 3/4**
- cumulative Part004 source coverage — **scans79–101 / 23 of 27**
...
- durable controls — `PART_005_TRANSLATION_PLAN.md`, `PART_005_GLOSSARY.md`, `PART_005_PROGRESS.md`
