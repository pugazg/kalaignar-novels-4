...
- blue-bordered copy-provenance / donation insert;
- the source visibly carries an opening parenthesis before மு.க.ஸ்டாலின்; no balancing closing parenthesis is visible on this scan, so the source-visible form is retained;
- this is copy-specific provenance matter, not novel body text;
...
- structural classification confirmed: **provenance-insert**;
- blue-bordered donation/provenance insert confirmed; isolated copy-provenance matter; no printed folio;
...
<!-- மூல மொத்த ஸ்கேன் பக்கம்: 2; பகுதி: 001; பகுதி உள்ளூர் பக்கம்: 2; அச்சுப் பக்கம்: —; PASS 1 TEXT-COMPLETE + PASS 2A REVIEWED + PASS 2B REVIEWED + PASS 3 REVIEWED / needs-review -->
