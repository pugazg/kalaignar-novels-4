...
| 005 | `TVA_BOK_0065559_தென்பாண்டிச்_சிங்கம்_2021_part_005_pages_106-132.pdf` | 27 | 106–132 | 48,768,215 | `4eaeef2e68daa5082662001f8906ca10ae207e95975a4207d3cdadd52708455b` | **COMPLETE / PASS** | **E17–E20 SOURCE-CHECKED / COMPLETE — WHOLE-PART ENGLISH GLOSSARY NEXT** |
...
## Part003 registered source facts

- source family / archive identifier: **TVA_BOK_0065559**
- exact source — `TVA_BOK_0065559_தென்பாண்டிச்_சிங்கம்_2021_part_003_pages_54-78.pdf`
- local pages — **25**
- global scans — **54–78**
...
- no usable embedded/parsed text layer
- rendered source page images are controlling
- first scan — printed page **42**, chapter6 continuation and close
- illustrated chapter openings — scan55 chapter7, scan62 chapter8, scan71 chapter9; source-visible folio absent on each opener
- last scan — printed page **66**, chapter9 open continuation
...
- Part002 state: **TAMIL ARCHIVAL-READY PASS / CLOSED — 27/27 verified Tamil + visual**
...
- Part002 Pass2B: **COMPLETE / PASS — 27/27 REVIEWED — scans27–53**
- Part002 Pass2B lexical / spacing / punctuation corrections: **5**
...
- Part002 final metadata/status sync: **PASS / CLOSED — 27/27 verified Tamil + visual**
...
- Part002 English batches reserved: **E5–E8**
...
- Part002 glossary files changed / terminology corrections: **1 / 9**
- Part002 unresolved glossary holds: **0**
- Part002 English editorial review: **PASS / CLOSED**
- Part002 editorial files reviewed / edited: **4/4 / 4/4**
...
- Part002 bilingual glossary recheck: **9/9 PASS**
...
## Part004 registered source facts

- source family / archive identifier — **TVA_BOK_0065559**
- exact source — `TVA_BOK_0065559_தென்பாண்டிச்_சிங்கம்_2021_part_004_pages_79-105.pdf`
- local pages — **27**
- global scans — **79–105**
...
- no usable embedded/parsed text layer
- rendered source page images are controlling
- first scan — printed page **67**, chapter9 continuation and close
- incoming 78→79 — **GENUINE CONTINUATION / AUDITED**
- direct physical continuation — `இப்போது உங்கள் / மனோரநிலை சரியில்லை. அதனால் பிறகு வருகிறேன். வணக்கம்.”`
- chapter openings — scan80 chapter10, scan90 chapter11, scan102 chapter12; source-visible folio absent on each opener
...
- canonical Part004 page records — **27/27**
- exact intake record — `SOURCE_INTAKE_PART_004.md`


## Part004 intake current state
...
- Part004 canonical records — **0/27**
...
## Part005 registered source facts
...
- rendered source pixels — **controlling**
- first scan — printed page **92**, chapter12 continuation
- incoming 105→106 — **GENUINE CONTINUATION / AUDITED**
- direct continuation — `அது என்னால் முடியும். / மலையோடு மோதிக்கொள்ளாதே என்று எச்சரிக்கை செய்து பாகனேரியை உங்கள் வழிக்குக் கொண்டு வருவது என் பொறுப்பு! அவசரப்பட்டுப் பாகனேரி மீது பகை கொள்ள வேண்டாமென்பது என் கருத்து.”`
...
- last scan — printed page **116**, chapter15 open continuation
- outgoing 132→133 — **PENDING direct audit / source-limited**
- canonical Part005 page records — **0/27**
- exact intake record — `SOURCE_INTAKE_PART_005.md`
